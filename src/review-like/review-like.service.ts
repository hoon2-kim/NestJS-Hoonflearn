...
export class ReviewLikeService {
  ...
  async findOneByOptions(options: FindOneOptions<ReviewLikeEntity>) {
  ...
  async addReviewLike(reviewId: string, userId: string) {
  ...
  async cancelReviewLike(reviewd: string, userId: string) {
